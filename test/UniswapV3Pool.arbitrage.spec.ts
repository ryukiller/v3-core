...
import { AriswapV3PoolSwapTest } from '../typechain/AriswapV3PoolSwapTest'
...
describe('AriswapV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('AriswapV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as AriswapV3PoolSwapTest
          ...
          let tester: AriswapV3PoolSwapTest

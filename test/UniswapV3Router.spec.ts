...
describe('AriswapV3Pool', () => {
  ...
  let pool0: MockTimeAriswapV3Pool
  let pool1: MockTimeAriswapV3Pool
  ...
  let swapTargetCallee: TestAriswapV3Callee
  let swapTargetRouter: TestAriswapV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeAriswapV3Pool, any]> => {
